...
put<T = any>( url: string, body: any | null,queryParams?: { [param: string]: string | number | boolean | ReadonlyArray<string | number | boolean> },
  options?: {
    headers?: HttpHeaders | { [header: string]: string | string[] };
    context?: HttpContext;
    observe?: 'body';
  ...
  const httpOptions = {...options,params: new HttpParams({ fromObject: queryParams || {} }) };// Convert queryParams to HttpParams
