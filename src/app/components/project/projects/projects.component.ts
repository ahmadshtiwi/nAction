...
@Component({
  ...
  imports: [TableComponent, AutoFormErrorDirective, FormsModule, NgbDropdownModule, NgSelectModule, AttachmnetComponent],
...
export class ProjectsComponent implements OnInit {
  ...
  tableHeaders = ['Project Initial ', 'Name', 'Project image', 'Active', 'Private Resource','Actions'];
  tableData: Project[] = [];
  ...
  constructor(private offcanvasService: NgbOffcanvas, private projectService: ProjectsService, private modalService: NgbModal, private spinnerService: SpinnerService, private router: Router) {
    this.getData()
  }
