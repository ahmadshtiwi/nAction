...
import { RejectModel, Tasks, TasksFilter } from './tasks.model';
...
@Component({
  selector: 'app-tasks',
  imports: [ CommonModule,TableComponent, AutoFormErrorDirective, FormsModule, NgbDropdownModule, NgSelectModule, NgbTimepickerModule, MaxValueDirective, AttachmnetComponent],
...
export class TasksComponent implements OnInit {
  ...
  tableHeaders = ['Project Initial', 'Title', 'Creation Date', 'Creator', 'Est. Hrs', 'Act. Hrs', 'Deadline', 'Assigned To', 'Status', 'Actions', 'Log'];
  tableData: Tasks[] = [];
  ...
  constructor(private offcanvasService: NgbOffcanvas, private taskService: TasksService, private spinnerService: SpinnerService,
    private loginService: LoginService, private lookupService: LookUpsService, private userService: UsersService, private modalService: NgbModal) {
    this.getData();
  }
