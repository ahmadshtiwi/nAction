...
@Component({
  selector: 'app-roles',
  imports: [Table, AutoFormErrorDirective, FormsModule, NgbDropdownModule, NgSelectModule],
...
export class RolesComponent  implements OnInit {
  ...
  mainPermissions : string[] = ['Resources' , 'APP:Roles' , 'Projects' , 'APP:Calendar' , 'Daily.Log' , 'Active.Tasks' , 'Report:Performance' , 'Report:Project.Cost','Report:Top.Ten','Dashboard','TaskSchedule'];

  constructor(private offcanvasService: NgbOffcanvas, private RoleService: RolesService , private modalService : NgbModal , 
    private perm : PermissionTransformService) {
    this.getData()
  }
  ...
  submitRequest(RolesForm:NgForm) {
    if(RolesForm.invalid)
      return;
    if (this.isAdd) {
